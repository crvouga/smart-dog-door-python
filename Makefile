...
test:
	clear
	python3 -m pytest -m "not slow" --exitfirst
...
check:
	...
	source .venv/bin/activate && python3 -m pytest -m "not slow" --exitfirst
	source .venv/bin/activate && python3 -m pytest -m "slow" --exitfirst
