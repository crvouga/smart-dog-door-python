...
def _test_dog(image_asset: str) -> None:
    f = Fixture()
...
def _test_not_dog(image_asset: str) -> None:
    f = Fixture()
...
def test_dog_clear_front() -> None:
    _test_dog("images/dog_clear_front/1.jpeg")


def test_dog_clear_front_2() -> None:
    _test_dog("images/dog_clear_front/2.jpeg")


def test_dog_security_footage_1() -> None:
    _test_dog("images/dog_security_footage/1.jpeg")


def test_dog_security_footage_2() -> None:
    _test_dog("images/dog_security_footage/2.jpeg")


def test_dog_security_footage_3() -> None:
    _test_dog("images/dog_security_footage/3.jpeg")


def test_not_dog_dog_clear_front() -> None:
    _test_not_dog("images/cat_clear_front/1.jpeg")


def test_not_dog_person_clear_front() -> None:
    _test_not_dog("images/person_clear_front/1.jpeg")
